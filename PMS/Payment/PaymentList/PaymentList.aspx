<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentList.aspx.cs" Inherits="PMS.Payment.PaymentList.PaymentList" %>
    ...
    <form id="frmMonthlyReport" runat="server">
        <div style="height:auto">
            ...
            <table style="height: 335px; width: 900px; margin-right: 0px; margin-bottom: 0px;">
                <tr>
                    <th class="auto-style5"> <h3 style="color: #3D1963; height: 40px;"> PAYMENTLIST </h3></th>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style6">
                        <asp:DropDownList ID="DDlinvo" runat="server" BackColor="#EEE4E4" BorderWidth="0px" Height="21px" Width="268px" ForeColor="#882464">
                            <asp:ListItem Text="search" Value="search"></asp:ListItem>
                ...
                <div style="height: auto">
                    <asp:Table ID="TMReport" runat="server" CellPadding="10" GridLines="Both" HorizontalAlign="center" width="80%">
                     ...
                     <tr>
                         <center>
                        <td><asp:Button ID="btnedit" runat="server" Text="EDIT" ForeColor="#FFFFFF" BackColor="#882464" Height="37px" Width="110px" BorderWidth="0px" CssClass="auto-style12" OnClick="btnedit_Click1"></asp:Button></td>
                       <td><asp:Button ID="btnback" runat="server" Text="BACK"ForeColor="#FFFFFF" BackColor="#882464" Height="37px" Width="110px" BorderWidth="0px" CssClass="auto-style12" OnClick="btnback_Click"></asp:Button></td>
                           <td><asp:Button ID="btnsave" runat="server" Text="SAVE" ForeColor="#FFFFFF" BackColor="#882464" Height="37px" Width="110px" BorderWidth="0px" CssClass="auto-style12" OnClick="btnsave_Click"></asp:Button></td>
                      </center>
                           </tr>
