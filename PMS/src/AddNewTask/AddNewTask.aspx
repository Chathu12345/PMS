     ...
     <table style="height: 620px; width: 600px">
        ...
        <th colspan="2"><h3 style="color:#3D1963; position:center;">Add Tasks</h3></th>
         ...
         <tr>
            ...
            <td><asp:DropDownList ID="ddlPname" runat="server" style="width: 75%; height:25px" BackColor="#EEE4E4" BorderWidth="1px" ForeColor="#882464" AutoPostBack="true" placeholder="Select" OnSelectedIndexChanged="ddlPname_SelectedIndexChanged1"></asp:DropDownList></td>
        </tr>
        <tr>
        ...
        <tr>           
            <td>
            <asp:Button ID="btnSubmit" runat="server" Text="Save" Height="37px" Width="110px" ForeColor="#FFFFFF" Backcolor="#882464" OnClick="btnSubmit_Click"></asp:Button>
            </td>
            <td colspan="2">
