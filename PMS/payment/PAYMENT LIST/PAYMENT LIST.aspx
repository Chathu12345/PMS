<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PAYMENT LIST.aspx.cs" Inherits="PMS.payment.PAYMENT_LIST.PAYMENT_LIST" %>
            ...
            <table style="height: 335px; width: 900px; margin-right: 0px; margin-bottom: 0px;">
                ...
                <div style="height: auto">
                    <asp:Table ID="TMReport" runat="server" CellPadding="10" GridLines="Both" HorizontalAlign="center" width="80%">
                     ...
                     <tr>
                         <center>
                        <td class="auto-style12"><asp:Button ID="Btnedit" runat="server" Text="EDIT" ForeColor="#FFFFFF" BackColor="#882464" Height="37px" Width="108px" BorderWidth="0px" OnClick="Btnedit_Click" />
                       <td> <asp:Button ID="Btnback" runat="server" Text="BACK" ForeColor="#FFFFFF" BackColor="#882464" Height="37px" Width="110px" BorderWidth="0px" CssClass="auto-style12" OnClick="Btnback_Click1" />
                           <td> <asp:Button ID="btnsave" runat="server" Text="SAVE" ForeColor="#FFFFFF" BackColor="#882464" Height="37px" Width="110px" BorderWidth="0px" CssClass="auto-style12" OnClick="btnsave_Click" />
                      </center>
                           </tr>
